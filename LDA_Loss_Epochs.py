...
if __name__ == '__main__':
    ...
    print("init LDA W :", LDA.variables)
    for i in range(30):
        print(i, "th epochs")
        ...
        # Picture
        scatter(label=train_labels, predict=featur_out, C0=C0, C1=C1, T_stat='Train', steps=i+1)
        ...
        # Picture
        scatter(label=test_labels, predict=featur_out, C0=C0, C1=C1, T_stat='Test', steps=i+1)
